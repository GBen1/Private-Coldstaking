...
echo ""
echo -e "${flred} - If you have already delegated less than 500parts to this pool and you want to add more funds thanks to cancel the pre-existing smartcontract in sending your funds to a new standard address in your wallet before running this script again ${neutre}"
echo ""

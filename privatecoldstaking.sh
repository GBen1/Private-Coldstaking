...
script1=$(ps -ef | grep bash | grep script1.sh | sed -n "1p" | cut -c10-16)
...
script2=$(ps -ef | grep bash | grep script2.sh | sed -n "1p" | cut -c10-16)
...
parttoanon=$(ps -ef | grep bash | grep sendparttoanon | sed -n "1p" | cut -c10-16)
...
anontopart=$(ps -ef | grep bash | grep anontopart  | sed -n "1p" | cut -c10-16)
...
anontoblind=$(ps -ef | grep bash | grep anontoblind  | sed -n "1p" | cut -c10-16)
...
anontoanon=$(ps -ef | grep bash | grep anontoanon  | sed -n "1p" | cut -c10-16)
...
script3=$(ps -ef | grep bash | grep script3.sh  | sed -n "1p" | cut -c10-16)
...
update=$(ps -ef | grep bash | grep "partyman update"  | sed -n "1p" | cut -c10-16)
